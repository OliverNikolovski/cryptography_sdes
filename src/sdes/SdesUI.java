...
class SdesUI extends JPanel implements ActionListener {
    ...
    public SdesOperations key;
    public SdesOperations message;
    ...
    public SdesOperations[] bits;                // The binary strings at each intermediate step
    ...
    public SdesUI() {
        ...
        key = new SdesOperations(10);
        message = new SdesOperations(8);
        ...
        bits = new SdesOperations[MAX_OUT];
    ...
    private void compute() {
        ...
        // Determine immediately if we are encrypting or decrypting
